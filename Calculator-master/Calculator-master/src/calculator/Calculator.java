 ...
 * Программа-калькулятор для вычисления простых арифметических операций с арабскими
 * и римскими числами. Программа реализована в одном классе - Calculator.java. В этом
